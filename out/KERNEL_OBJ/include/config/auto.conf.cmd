...
ifneq "$(KERNELVERSION)" "4.19.312"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "Android (4691093 based on r316199) clang version 6.0.2 (https://android.googlesource.com/toolchain/clang 183abd29fc496f55536e7d904e0abae47888fc7f) (https://android.googlesource.com/toolchain/llvm 34361f192e41ed6e4e8f9aca80a4ea7e9856f327) (based on LLVM 6.0.2svn)"
include/config/auto.conf: FORCE
endif
...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-android --prefix=/usr/bin/aarch64-linux-android- --gcc-toolchain=/usr -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
